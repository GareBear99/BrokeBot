...
layout: default
title: BrokeBot
description: TRON Funding-Rate Arbitrage (CEX, Python) — part of the ARC Trading Fleet.
---

# BrokeBot
**TRON Funding-Rate Arbitrage (CEX, Python)**

[![Source](https://img.shields.io/badge/source-GitHub-181717?logo=github)](https://github.com/GareBear99/BrokeBot)
...
- **Source code and full README**: [https://github.com/GareBear99/BrokeBot](https://github.com/GareBear99/BrokeBot)
- **Architecture notes**: [docs/ARCHITECTURE.md](https://github.com/GareBear99/BrokeBot/blob/main/docs/ARCHITECTURE.md)
- **Usage / operator guide**: [docs/USAGE.md](https://github.com/GareBear99/BrokeBot/blob/main/docs/USAGE.md)
- **Security policy**: [SECURITY.md](https://github.com/GareBear99/BrokeBot/blob/main/SECURITY.md)
- **Contributing**: [CONTRIBUTING.md](https://github.com/GareBear99/BrokeBot/blob/main/CONTRIBUTING.md)
